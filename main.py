...
genNo = input("Enter your Societys Generations: ")
while len(genNo) == 0:
    genNo = input("Enter your Societys Generations: ")
...
def addOneHundred(newPop):
    fillerValue = newPop + 100
    return fillerValue
#I added a function to add 100 to the new population as needed
if int(genNo) > 0:
    if int(popNo) <= 1:
